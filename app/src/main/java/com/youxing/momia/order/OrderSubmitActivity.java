 ...
 */
public class OrderSubmitActivity extends TQActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.add) {
            startActivityForResult(new Intent(Intent.ACTION_VIEW,
                    Uri.parse("tq://tripperson")), REQUEST_CODE_SELECT_PERSON);

        } else if (v.getId() == R.id.done) {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("tq://cashier")));
        }
